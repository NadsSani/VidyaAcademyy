...
public class AdminList extends AppCompatActivity {
    ...
    ArrayList<Princi_Admin_CardDetails> arrayList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recy_princi_cardadmin);
        Intent i = getIntent();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    Princi_Admin_CardDetails princi_admin_cardDetails= new Princi_Admin_CardDetails(dataSnapshot1.child("name").getValue().toString(),dataSnapshot1.getKey().toString(),dataSnapshot1.child( "image" ).getValue().toString());
