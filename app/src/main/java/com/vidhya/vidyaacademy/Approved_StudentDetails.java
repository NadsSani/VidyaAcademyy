...
public class Approved_StudentDetails extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_approved_student_details );
        tv_stud_name_approved = findViewById( R.id.tv_stud_name_approved );
        tv_stud_address_approved = findViewById( R.id.tv_stud_address_approved );
        tv_stud_pname_approved = findViewById( R.id.tv_stud_pname_approved );
       // btn_cancel_princi_studdetails = findViewById( R.id.btn_cancel_princi_studdetails );
        ...
        tv_stud_photo_approved = findViewById( R.id.tv_stud_photo_approved );
        ...
        databaseReference.addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    Glide.with( getApplicationContext() ).load( dataSnapshot.child( "image" ).getValue().toString() ).into( tv_stud_photo_approved );
